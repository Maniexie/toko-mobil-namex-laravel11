    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="/" class="logo d-flex align-items-center">
                ...
                <span class="d-none d-lg-block">Monex</span>
            </a>
    ...
    @section('sidebar')
        ...
        <aside id="sidebar" class="sidebar">
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" data-bs-target="#customer-nav" data-bs-toggle="collapse"
                        href="#">
                        <i class="bi bi-menu-button-wide"></i><span>Customer</span><i
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" data-bs-target="#data-mobil-nav" data-bs-toggle="collapse"
                        href="#">
                        <i class="bi bi-menu-button-wide"></i><span>Mobil</span><i class="bi bi-chevron-down ms-auto"></i>
                    </a>
                    <ul id="data-mobil-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                        <li>
                            <a href="data-mobil-alerts.html">
                                <i class="bi bi-circle"></i><span>Data Mobil</span>
                            </a>
                        </li>
                    </ul>
                </li><!-- End data-mobil Nav -->

                <li class="nav-item">
                    <a class="nav-link collapsed" data-bs-target="#data-transaksi-nav" data-bs-toggle="collapse"
                        href="#">
                    ...
                    <ul id="data-transaksi-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                        <li>
                            <a href="data-transaksi-alerts.html">
                                <i class="bi bi-circle"></i><span>Data Sewa</span>
                            </a>
                        </li>
                    </ul>
